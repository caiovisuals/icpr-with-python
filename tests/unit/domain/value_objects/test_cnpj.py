...
@pytest.mark.parametrize("entry", ["11.222.333/0001-81", " 11222333000181 ", "11222333/000181"])
def test_ignora_pontuacao(entry):
    assert CNPJ.parse(entry).digits == "11222333000181"
...
@pytest.mark.parametrize("entry", ["", "112223330001", "112223330001812"])
def test_recusa_tamanho_errado(entry):
